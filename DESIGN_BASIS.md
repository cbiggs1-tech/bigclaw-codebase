...
*(OpenRouter shadow dialectic / Grok-as-Judge is experimental shadow-only and is **not** documented as production until graduated — live Judge remains Anthropic Opus 4.8 with Sonnet Bull/Bear.)*
